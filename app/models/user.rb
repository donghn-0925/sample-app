class User < ApplicationRecord
  ...
  def activate
    update_columns(activated: true, activated_at: Timezone.now)
  end
  ...
  def feed
    # following_ids = "SELECT followed_id FROM relationships WHERE follower_id = 1"
    Micropost.by_id(id, Relationship.followed_ids(id)).list_desc
